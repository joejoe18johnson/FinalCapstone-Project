  ...
  return (
    <Container {...props}>
      <ul>
        ...
        <li className="nav-li"> <HashLink to="/">Home</HashLink> </li>
        <li className="nav-li"> <HashLink to="/#about">About</HashLink> </li>
        <li className="nav-li"> <HashLink to="/#menu">Menu</HashLink> </li>
        <li className="nav-li"> <HashLink to="/bookings">Reservations</HashLink> </li>
