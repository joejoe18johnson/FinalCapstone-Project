  ...
  return (
    <Container {...props} id="menu">
      ...
      <Form onSubmit={formik.handleSubmit} noValidate>
        ...
        <input type="text" data-testid="name" id="res-date" {...formik.getFieldProps("name")} />
        <FormMessageError data-testid="name-error">
          {formik.touched.time && formik.errors.time}
        </FormMessageError>


        <label htmlFor="res-date">Date of Reservation</label>
        ...
        <select data-testid="occasion" id="occasion" {...formik.getFieldProps("occasion")}>
          ...
          <option value="anniversary" className="opt">Graduation</option>
